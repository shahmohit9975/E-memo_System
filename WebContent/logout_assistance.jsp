...
session.removeAttribute("memo_filled_by_id_ass");
session.removeAttribute("memo_filled_by_ass");
...
session.removeAttribute("rules_id");
...
session.removeAttribute("img_path");
...
%>
<jsp:include page="Login_Assistance.jsp"/>

...
<body>
		...
		<table border="0" align="center">
			...
			<tr>
				...
				<td align="center" colspan="2"><input type="file" name="file"
					id="profile-img" onchange="path_store_in_session()"> <script
				...
				<td rowspan="7"><img src="" id="profile-img-tag"
			...
			<tr>
				...
				<td><select onchange="hello()" name="rules_name">
						<option value="-------">-------</option>
						<%
							while (rs3.next()) {
 ...
 %></td>
			...
			<tr>
				...
				<td align="center"><input type="submit" value="GENERATE MEMO"
					class="generete_button" style="margin-right: 35px;"></td>

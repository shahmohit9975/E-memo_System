...
<body>
	...
	<%
		try {
			...
			Integer memo_filled_by_id_ass = (Integer) session.getAttribute("memo_filled_by_id_police");
			...
			int rules_break_status = 0;

			if (rules_id_1 != null && rules_id_2 == null && rules_id_3 == null) {
				rules_break_status = 1;

			} else if (rules_id_1 == null && rules_id_2 != null && rules_id_3 == null) {
				rules_break_status = 1;
				rules_id_1 = rules_id_2;
			} else if (rules_id_1 == null && rules_id_2 == null && rules_id_3 != null) {
				rules_break_status = 1;
				rules_id_1 = rules_id_3;
			} else if (rules_id_1 != null && rules_id_2 != null && rules_id_3 == null) {
				rules_break_status = 2;

			} else if (rules_id_1 != null && rules_id_2 == null && rules_id_3 != null) {
				rules_break_status = 2;
				rules_id_2 = rules_id_3;
			} else if (rules_id_1 == null && rules_id_2 != null && rules_id_3 != null) {
				rules_break_status = 2;
				rules_id_1 = rules_id_3;
			} else if (rules_id_1 != null && rules_id_2 != null && rules_id_3 != null) {
				rules_break_status = 3;

			} else {

				rules_break_status = 0;
			}
			...
			String rules_name_1 = null;
			String rules_name_2 = null;
			String rules_name_3 = null;
			if (rules_break_status == 1) {
				PreparedStatement ps1 = con.prepareStatement("SELECT rules_name FROM ememo.rules where rules_id=" + rules_id_1);
				ResultSet rs1 = ps1.executeQuery();
				while (rs1.next()) {
					rules_name_1 = rs1.getString(1);
				}
				table.addCell("8");
				table.addCell("Rules name");
				table.addCell(rules_name_1);
				try {
					// date=String.valueOf(ourJavaTimestampObject);
				...
				ps1 = con.prepareStatement("SELECT rules_name FROM ememo.rules where rules_id=" + rules_id_2);
				rs1=null;
				rs1 = ps1.executeQuery();
				while (rs1.next()) {
					rules_name_2 = rs1.getString(1);
				}
				table.addCell("8");
				table.addCell("Rules name");
				table.addCell(rules_name_1);
				...
				ps1 = con.prepareStatement("SELECT rules_name FROM ememo.rules where rules_id=" + rules_id_3);
				rs1=null;
				rs1 = ps1.executeQuery();
				while (rs1.next()) {
					rules_name_3 = rs1.getString(1);
				}
				table.addCell("8");
				table.addCell("Rules name");
				table.addCell(rules_name_1);

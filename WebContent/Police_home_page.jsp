...
<script>
	...
	function hello() {
		...
		var rules_name_1 = document.rules_break.rules_name_1.value;
		var rules_name_2 = document.rules_break.rules_name_2.value;
		var rules_name_3 = document.rules_break.rules_name_3.value;
		var vehicle_number = document.rules_break.vehicle_number.value;

		var url = "save_value_in_session_police.jsp?rules_break_state="
				+ rules_break_state + "&rules_break_city=" + rules_break_city
				+ "&rules_break_place=" + rules_break_place + "&rules_name_1="
				+ rules_name_1 + "&rules_name_2=" + rules_name_2
				+ "&rules_name_3=" + rules_name_3 + "&vehicle_number="
				+ vehicle_number;
		request.open("GET", url, true);
		request.send();
	}
